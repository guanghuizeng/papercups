...
export default function InviteeQuestionsSectionExpand({
  user,
  eventType,
  onClose,
  onSave,
  ...
  return (
    <div
      ...
      className={`mt-2 border-b lg:border lg:border-2 border-black lg:rounded `}
    >
      <div
      ...
      >
        ...
        <div className="flex flex-row">
          ...
          <div className="mx-2">Save & Close</div>
        </div>
      </div>
